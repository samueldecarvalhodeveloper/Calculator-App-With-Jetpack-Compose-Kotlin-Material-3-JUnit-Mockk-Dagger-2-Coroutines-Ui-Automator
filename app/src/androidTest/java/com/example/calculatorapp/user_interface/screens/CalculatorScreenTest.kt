...
import com.example.calculatorapp.constants.UserInterfaceConstants.STORING_VALUE_DELAY
...
class CalculatorScreenTest {
    ...
    fun beforeEach() {
        ...
        runTest {
            ThemeDataStore.setNightModeThemeState(false,context)
        }
    ...
    fun testIfActionBarActionButtonTogglesThemeMode() = runBlocking {
        val initialNightThemeState = ThemeDataStore.getNightModeThemeState(context)
        ...
        val currentNightThemeState = ThemeDataStore.getNightModeThemeState(context)
